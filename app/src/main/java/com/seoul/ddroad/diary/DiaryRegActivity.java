        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               ...
               // Toast.makeText(DiaryRegActivity.this,"선택된 아이템 : "+position,Toast.LENGTH_SHORT).show();
                if(position == 1 ){
                    mImgStr = "@drawable/circle1";
                }else if(position == 2){
                    mImgStr = "@drawable/circle2";
                }else if(position == 3){
                    mImgStr = "@drawable/circle3";
                }else if(position == 4){
                    mImgStr = "@drawable/circle4";
                }else if(position == 5){
                    mImgStr = "@drawable/circle5";
                }else if(position == 6){
                    mImgStr = "@drawable/circle6";
                }else{
                    mImgStr = "";
                }
            }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                Toast.makeText(DiaryRegActivity.this, "수정완료", Toast.LENGTH_SHORT).show();
                                onBackPressed();
                                finish();
                            }
                        })
                        .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                // 취소시 처리 로직
                                Toast.makeText(DiaryRegActivity.this, "취소", Toast.LENGTH_SHORT).show();
                            }
                        })
                        .show();
                //confirm 다이얼 로그 end
